...
class _EnquiryListState extends State<EnquiryList> {
  ...
  getEnquirListApi() async {
    ...
    var request =
        http.MultipartRequest('POST', Uri.parse('${baseUrl}get_inquery_list'));
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              return SingleChildScrollView(
                child: enquirModel == null || enquirModel == ""
                    ? const Center(child: CircularProgressIndicator())
                    : enquirModel!.data!.length == 0
                        ? const Center(child: Text("No Enquiry Found!!"))
                        : Container(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    "${enquirModel!.data![i].createdAt!.substring(0, 11)}")
                                              ],
                                            ),
                                            SizedBox(
                                              height: 5,
