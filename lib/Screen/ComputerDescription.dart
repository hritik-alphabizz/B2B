...
class ComputerDescription extends StatefulWidget {
  const ComputerDescription({Key? key, this.image, this.loc, this.price, this.product_name}) : super(key: key);
  final  String? image,loc,price,product_name;

  @override
  State<ComputerDescription> createState() => _ComputerDescriptionState();
}

class _ComputerDescriptionState extends State<ComputerDescription> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: DataTable(
                ...
                rows: [
                  ...
                  DataRow(
                      ...
                      cells: [
                        DataCell(Text('Usage/Application',
                          style: TextStyle(fontWeight: FontWeight.normal,
                              color:Colors.grey.shade600,
                              fontSize:14),)),
                  ...
                  DataRow(cells: [
                    DataCell(Text('Services Charge',
                      style: TextStyle(fontWeight: FontWeight.normal,
                          color:Colors.grey.shade600,
                          fontSize:14),)),
                    DataCell(Text('As applicable',
                      style: TextStyle(fontWeight: FontWeight.bold,
                          color:Colors.black,
                          fontSize:14),)),
                  ]),
                      ...
                      cells: [
                        DataCell(Text('Feature',
                          style: TextStyle(fontWeight: FontWeight.normal,
                              color:Colors.grey.shade600,
                              fontSize:14),)),
                        DataCell(Text('Less Maintenance',
                          style: TextStyle(fontWeight: FontWeight.bold,
                              color:Colors.black,
                              fontSize:14),)),
                      ]),
            ...
            Container(
                ...
                child:Text(
                  "Our company has achieves widespread recognition for providing good products to clients. offered product is precisely developed and reasonable in rate.",
                  style: TextStyle(fontWeight: FontWeight.normal,
                      color:Colors.black,
                      fontSize:16),
                )
